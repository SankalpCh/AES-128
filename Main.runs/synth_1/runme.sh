...
HD_PWD='D:/Project/Main/Main.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cntrlr_enc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cntrlr_enc.tcl
